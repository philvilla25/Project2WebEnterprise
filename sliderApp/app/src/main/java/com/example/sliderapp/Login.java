        ...
        buttonLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(user)){
                    Toast enterUsername = Toast.makeText(Login.this, "Enter Username", Toast.LENGTH_SHORT);
                    return;
                }

                if (TextUtils.isEmpty(password)){
                    Toast enterPassword = Toast.makeText(Login.this, "Enter Password", Toast.LENGTH_SHORT);
                    return;
                }
